...
function RulesContent() {
	...
	return (
		<>
			<div className="flex flex-col items-center gap-10 p-4 mx-6 bg-white border rounded-xl">
				<p className="text-4xl font-bold text-slate-700">RULES</p>
				...
				<button
					...
					className="px-4 py-3 text-white transition-all duration-300 ease-in-out transform bg-white rounded-full hover:bg-slate-200 focus:outline-none focus:ring-2 focus:ring-slate-200 focus:ring-offset-2"
				>
					<svg
