	...
	return (
		<div className="relative flex items-center justify-center w-full mt-24">
			<svg
				...
				width="250"
				height="220"
				className="top-0 scale-100 sm:scale-125 lg:scale-150"
			>
				<path
					stroke="#000"
					stroke-width="12"
			...
			<button
				onClick={() => dispatch(picked("paper"))}
				className="flex absolute lg:left-8 right-40 top-1 lg:-mt-10 transform -translate-y-1/2 justify-center items-center border-[15px] lg:border-[20px] border-blue-600 w-32 h-32 sm:w-40 sm:h-40 lg:w-48 lg:h-48 rounded-full bg-gray-300 shadow-inner-heavy"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="49"
					height="59"
					className="w-12 h-auto transition-all duration-300 ease-in-out sm:w-16 hover:scale-110"
					viewBox="0 0 49 59"
				>
					<path
						fill="#3B4262"
			...
			<button
				onClick={() => dispatch(picked("scissors"))}
				className="flex absolute left-40 lg:left-80 top-1 lg:-mt-10 transform -translate-y-1/2 justify-center lg:border-[20px] items-center border-[15px] border-yellow-600 w-32 h-32 rounded-full bg-gray-300 shadow-inner-heavy sm:w-40 sm:h-40 lg:w-48 lg:h-48"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="49"
			...
			<button
				onClick={() => dispatch(picked("rock"))}
				className="flex absolute left-1/2 bottom-0 transform -translate-x-1/2 lg:border-[20px] top-48 -translate-y-1/2 justify-center items-center border-[15px] border-red-500 w-32 h-32 rounded-full bg-gray-300 shadow-inner-heavy lg:w-48 lg:h-48 sm:w-40 sm:h-40"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="49"
					height="59"
					className="w-12 h-auto -mb-4 transition-all duration-300 ease-in-out sm:w-16 hover:scale-110"
					viewBox="0 0 49 59"
				>
					<path
						fill="#3B4262"
