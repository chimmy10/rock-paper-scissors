...
function ContentPicked() {
	...
	const compPick = useSelector((state) => state.game.compPick);

	return (
		<div className="flex items-center justify-center gap-7 sm:gap-20 lg:gap-28">
			<div className="flex flex-col items-center justify-center">
				<div
					className={`flex justify-center items-center border-[15px] lg:border-[20px]  w-32 h-32 sm:w-40 sm:h-40 lg:w-48 lg:h-48 rounded-full bg-gray-300 shadow-inner-heavy ${
						pick === "paper"
							? "border-blue-600"
							: pick === "scissors"
							? "border-yellow-600"
				...
				>
					{pick === "paper" ? (
						...
						<svg
							...
							width="49"
							height="59"
							className="w-12 h-auto -mb-4 sm:w-16"
							viewBox="0 0 49 59"
						>
							<path
								fill="#3B4262"
				...
				<p className="font-semibold text-white shadow-sm text-md mt-7 md:text-xl lg:text-2xl">
					YOU PICKED
				</p>
			</div>
			...
			{/* <div className="flex flex-col items-center justify-center">
				<div className="bg-blue-800 border-[15px] lg:border-[20px] border-blue-950 rounded-full p-[50px] sm:w-40 sm:h-40 lg:w-48 lg:h-48"></div>
				<p className="font-semibold text-white shadow-sm mt-7 text-md md:text-xl lg:text-2xl">
					THE HOUSE PICKED
				</p>
			</div> */}
		</div>
